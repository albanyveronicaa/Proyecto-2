...
public class ProyectoHash {
    ...
    public static ManejoDocumentos main = new ManejoDocumentos();
...
class JenkinsHash {
    ...
    /**
     * Calculate a 32-bit hash value, using the method signature and parameters
     * matching those of the original Lookup3.c#hashLittle method.
     *
     * @param input The data.
     * @param length The number of elements (starting from index 0) from the
     * input array to calculate the hash on.
     * @param pc The offset for the hash for incremental hashes or {@code 0} for
     * a new hash.
     *
     * @return 32-bit hash value.
     */
    ...
    /**
     * Calculate a 64-bit hash value, using the method signature and parameters
     * matching those of the original Lookup3.c#hashLittle2 method.
     *
     * @param input The data.
     * @param length The number of elements (starting from index 0) from the
     * input array to calculate the hash on.
     * @param pc The offset for the hash for incremental hashes or {@code 0} for
     * a new hash.
     * @param pb The offset for the hash for incremental hashes or {@code 0} for
     * a new hash.
     *
     * @return 64-bit hash value.
     */
